#include "Praticante.h"
#include "Plano.h"
#include "Aula.h"
#include <iostream>
#include <algorithm>

Praticante::Praticante(const std::string& nome, const std::string& cpf, const std::string& genero)
...
void Praticante::exibirDetalhes() const {
    ...
    std::cout << "Total de aulas inscritas: " << aulasInscritas.size() << std::endl;
}