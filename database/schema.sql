...
CREATE TABLE
  IF NOT EXISTS Aula (
    ...
    FOREIGN KEY (instrutor_id) REFERENCES Instrutor (id) FOREIGN KEY (tipo_aula_id) REFERENCES TipoDeAula (id)
  );

CREATE TABLE
  IF NOT EXISTS Participa (
